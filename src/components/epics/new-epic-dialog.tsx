...
export function NewEpicDialog({ pods }: { pods: Pod[] }) {
      ...
      <DialogContent>
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <DialogHeader>
            ...
            <DialogDescription>
              Create an epic and assign it to a pod.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              placeholder="e.g. Search relevance overhaul"
              required
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            <Label>Pod</Label>
            <Select value={podId} onValueChange={(value) => setPodId(value ?? "")}>
